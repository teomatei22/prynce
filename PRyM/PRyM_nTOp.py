...
def RecomputeWeakRates(Tvec):
    ...
    if PRyMini.compute_nTOp_flag:
        ...
        (
            ...
            nTOp_frwrdvec_LT,
            nTOp_bkwrdvec_LT,
        ) = PRyMevalnTOp.ComputeWeakRates(Tvec)
        # HT interval: T_start --> T_weak
        nTOp_frwrd_HT = interp1d(
            T_interval_HT,
            nTOp_frwrdvec_HT,
