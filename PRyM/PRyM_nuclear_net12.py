...
class UpdateNuclearRates(object):
    ...
    def dYddt(self, Y, T_t, rhoBBN, nTOp_frwrd, nTOp_bkwrd):
        ...
        return (
            ...
            + 2.0 * rhoBBN * self.ddtp_bkwrd(T_t) * Yn0p1 * Yn2p1
            - rhoBBN * self.tdan_frwrd(T_t) * Yn1p1 * Yn2p1
            + self.dpHe3g_bkwrd(T_t) * Yn1p2
            + 2.0 * rhoBBN * self.ddHe3n_bkwrd(T_t) * Yn1p0 * Yn1p2
            - rhoBBN * self.He3dap_frwrd(T_t) * Yn1p1 * Yn1p2
            + rhoBBN * self.tdan_bkwrd(T_t) * Yn1p0 * Yn2p2
            + rhoBBN * self.He3dap_bkwrd(T_t) * Yn0p1 * Yn2p2
        )
    ...
    def Jacobian(self, Y, T_t, rhoBBN, nTOp_frwrd, nTOp_bkwrd):
        ...
        # Yn
        dYn_primeOdYn = -nTOp_frwrd(T_t) + rhoBBN * (
        ...
        dYp_primeOdYp = -nTOp_bkwrd(T_t) + rhoBBN * (
            -self.npdg_frwrd(T_t) * Yn1p0
        ...
        dYp_primeOdYa = rhoBBN * (
            -self.He3dap_bkwrd(T_t) * Yn0p1 + self.Li7paa_bkwrd(T_t) * Yn2p2
        ) + self.tpag_bkwrd(T_t)
        ...
        dYd_primeOdYd = rhoBBN * (
            -self.dpHe3g_frwrd(T_t) * Yn0p1
            - 2.0 * (self.ddHe3n_frwrd(T_t) + self.ddtp_frwrd(T_t)) * Yn1p1
        ...
        dYd_primeOdYa = rhoBBN * (
            self.tdan_bkwrd(T_t) * Yn1p0 + self.He3dap_bkwrd(T_t) * Yn0p1
        )
        dYd_primeOdYLi7 = 0.0
        dYd_primeOdYBe7 = 0.0
        dYd_row = [
        ...
        dYa_primeOdYp = rhoBBN * (
            -self.He3dap_bkwrd(T_t) * Yn2p2
            + 2.0 * self.Li7paa_frwrd(T_t) * Yn4p3
            + self.tpag_frwrd(T_t) * Yn2p1
        )
        dYa_primeOdYd = rhoBBN * (
            self.He3dap_frwrd(T_t) * Yn1p2 + self.tdan_frwrd(T_t) * Yn2p1
        )
        ...
        dYa_primeOdYLi7 = 2.0 * rhoBBN * self.Li7paa_frwrd(
            T_t
        ) * Yn0p1 + self.taLi7g_bkwrd(T_t)
        ...
        dYLi7_primeOdYp = (
            -rhoBBN * (self.Be7nLi7p_bkwrd(T_t) + self.Li7paa_frwrd(T_t)) * Yn4p3
        )
        dYLi7_primeOdYd = 0.0
        dYLi7_primeOdYt = rhoBBN * self.taLi7g_frwrd(T_t) * Yn2p2
        dYLi7_primeOdYHe3 = 0.0
        dYLi7_primeOdYa = rhoBBN * (
            self.Li7paa_bkwrd(T_t) * Yn2p2 + self.taLi7g_frwrd(T_t) * Yn2p1
        )
        dYLi7_primeOdYLi7 = -rhoBBN * (
        ...
        dYBe7_primeOdYBe7 = -rhoBBN * self.Be7nLi7p_frwrd(
            T_t
        ) * Yn1p0 - self.He3aBe7g_bkwrd(T_t)
        dYBe7_row = [
            dYBe7_primeOdYn,
            dYBe7_primeOdYp,
            dYBe7_primeOdYd,
